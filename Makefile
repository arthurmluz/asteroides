...
PROG = main
FONTES = app/Ponto.cpp app/Cor.cpp app/Poligono.cpp app/Temporizador.cpp app/ListaDeCoresRGB.cpp app/Instancia.cpp util/bezierFunc.cpp util/desenhar.cpp util/movimentos.cpp main.cpp 
